...
//hien thi thong tin  
router.get('/info-users', UsersControllers.authenticateJWT, UsersControllers.getUsers);
//
router.get('/History/customer-pet', UsersControllers.authenticateJWT, UsersControllers.History_pet_byIDCustomer);
